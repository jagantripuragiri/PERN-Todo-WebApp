      ...
      <div className="bg-gray-50 rounded-2xl shadow-xl w-full max-w-lg p-8">
        ...
        >
          <input
            ...
            placeholder="What needs to be done Jagan?"
            required
          />
          <button className="bg-neutral-950 hover:bg-neutral-600 text-white px-4 py-2 rounded-md font-medium cursor-pointer">
            Add Task
          </button>
        </form>
        <div>
                    ...
                    <div className="flex items-center gap-x-3">
                      ...
                      <div>
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-neutral-950 text-white rounded-lg mt-2 hover:bg-neutral-600 duration-200"
                        >
                          <IoClose />
                        </button>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <button
                          ...
                          className={`flex-shrink-0 h-6 w-6 border-2 rounded-full flex items-center justify-center ${
                            todo.completed
                              ...
                              : "border-gray-300 hover:border-neutral-700"
                          }`}
                        >
                      ...
                      <div className="flex gap-x-2">
                        <button
                          ...
                          className="p-2 text-neutral-500 hover:text-neutral-700 rounded-lg hover:bg-blue-50 duration-200"
                        >
                          <MdModeEditOutline />
                        </button>
                        <button
